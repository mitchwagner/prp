...
#+END_SRC
[[/data/annaritz/projects/2015-03-pathlinker/viz/precision-recall/netpath/Wnt-netpathkeggunion.png]]
...
#+BEGIN_SRC bash
python master-script.py --weightedppi --ppiversion pathlinker-signaling-children-reg \
--kegg --pathlinker --pagerank --pcsf --ipa --shortestpaths --responsenet --anat --computeprecrec --precrecviz --forceviz
#+END_SRC
[[/data/annaritz/projects/2015-03-pathlinker/viz/precision-recall/kegg/hsa04310.png]]
...
[[/data/annaritz/projects/2015-03-pathlinker/viz/precision-recall/aggregate-ignorekeggpositives.png]]
*** Evaluate KEGG Inputs, ignoring NetPath positives
#+BEGIN_SRC bash
python master-script.py --weightedppi --ppiversion pathlinker-signaling-children-reg \
--kegg --ignorenetpathpositives --pathlinker --pagerank --computeprecrec --precrecviz --forceviz
#+END_SRC

[[/data/annaritz/projects/2015-03-pathlinker/viz/precision-recall/hsa04310-ignorenetpathpositives.png]]
[[/data/annaritz/projects/2015-03-pathlinker/viz/precision-recall/aggregate-kegg-ignorenetpathpositives.png]]
** Make Networks for all overlapping networks
python master-script.py --weightedppi --ppiversion pathlinker-signaling-children-reg \
--graphspace --pathlinker --ignorekeggpositives
