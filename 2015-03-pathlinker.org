...
#+BEGIN_SRC bash 
python master-script.py --ppiversion pathlinker-signaling-children-reg --weightedppi --allnetpath --pathlinker --pagerank \ 
--computeprecrec --precrecviz --forceviz
#+END_SRC
[[/data/annaritz/projects/2015-03-pathlinker/viz/precision-recall/netpath/aggregate.png]
...
#+BEGIN_SRC bash
python master-script.py --weightedppi --ppiversion pathlinker-signaling-children-reg \
--oldgraphspace --pathlinker --pagerank --anat --shortestpaths --pcsf --ipa --responsenet
#+END_SRC
